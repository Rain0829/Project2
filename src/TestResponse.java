...
public class TestResponse {
    ...
    public static void main(String[] args) {
        Response response = new Response(1, "M", 3, 1, 3, 2, 1, 1, 2022, "Some string", 1, 2, 3, 4, 1, 2, "Another string", 2, 3, 4, 1, 2, "Yet another string", 3, 3, 4, 1, 2, 3, 4, 5);
        ...
        CustomHashTable responses = ReadFile.readResponsesFromFile("responses.txt");
        System.out.println(responses.size());
        System.out.println("Testing method 1:");
        int[] test1 = SurveyDataAnalyzer.genderDistribution(responses); // Call the method to get the test results
        ...
        int[] test2 = SurveyDataAnalyzer.ageGroupDistribution(responses); // Call the method to get the test results
        ...
        int[] test3 = SurveyDataAnalyzer.residenceDistribution(responses); // Call the method to get the test results
        ...
        int[] test4 = SurveyDataAnalyzer.educationDistribution(responses); // Call the method to get the test results
        ...
        int[] test5 = SurveyDataAnalyzer.incomeDistribution(responses); // Call the method to get the test results
        ...
        int[] test6 = SurveyDataAnalyzer.maritalDistribution(responses); // Call the method to get the test results
        ...
        int[] test7 = SurveyDataAnalyzer.smokerDistribution(responses); // Call the method to get the test results
        int[] result7 = new int[]{188, 112};
        ...
        double test8 = SurveyDataAnalyzer.lifeQualityGeneral(responses); // Call the method to get the test results
        ...
        double[] test9 = SurveyDataAnalyzer.lifeQualityGenderBased(responses); // Call the method to get the test results
        ...
        double[] test10 = SurveyDataAnalyzer.lifeQualityAgeBased(responses); // Call the method to get the test results
        ...
        double[] test11 = SurveyDataAnalyzer.lifeQualityResidenceBased(responses); // Call the method to get the test results
        ...
        double[] test12 = SurveyDataAnalyzer.lifeQualityEducationBased(responses); // Call the method to get the test results
        ...
        double[] test13 = SurveyDataAnalyzer.lifeQualityIncomeBased(responses); // Call the method to get the test results
        ...
        double[] test14 = SurveyDataAnalyzer.lifeQualityMaritalBased(responses); // Call the method to get the test results
        ...
        double[] test15 = SurveyDataAnalyzer.lifeQualitySmokerBased(responses); // Call the method to get the test results
        ...
        String[] test17 = SurveyDataAnalyzer.mostCommonSymptoms(responses); // Call the method to get the test results
        String[] result17 = new String[]{"Weakness","Cough", "ShortnessOfBreath", "ChestPain", "Hoarseness", "CoughingUpBlood" };
        ...
        String[] test18 = SurveyDataAnalyzer.mostCommonLifeAspects(responses); // Call the method to get the test results
        String[] result18 = new String[]{"PsychologicalAspect", "PhysicalAspect", "ProfessionalLife", "FamilyLife", "SocialLife"};
        ...
        double[] test19 = SurveyDataAnalyzer.lifeQualityMixConditionsBased(responses); // Call the method to get the test results
        ...
        double[] test20 = SurveyDataAnalyzer.lifeQualityResponseBased(responses); // Call the method to get the test results
